...
## [1.1.1] - 2020-01-19 ([PR 44](https://github.com/dogma-io/nodely/pull/44))
...
## [1.1.0] - 2020-01-19 ([PR 42](https://github.com/dogma-io/nodely/pull/42))

### Changed
-   Dependencies to latest versions.

## [1.0.0] - 2019-10-26 ([PR 41](https://github.com/dogma-io/nodely/pull/41))

### Changed
*   CI to use `bumper` instead of `pr-bumper`
*   dependencies to latest versions

## [0.8.0] - 2018-09-02 ([PR 37](https://github.com/dogma-io/nodely/pull/37))

### Changed
*   Dependencies to latest versions.

## [0.7.0] - 2018-06-13 ([PR 36](https://github.com/dogma-io/nodely/pull/36))

### Changed
*   To latest dependencies which now uses latest version of Babel 7 alpha packages.

## [0.6.0] - 2018-06-05 ([PR 33](https://github.com/dogma-io/nodely/pull/33))

### Changed
*   Default builds to target ES5 instead of Node 6.

## [0.5.1] - 2018-05-28 ([PR 32](https://github.com/dogma-io/nodely/pull/32))

### Added
*   `@babel/core` back to dependencies to not break consumers.

## [0.5.0] - 2018-05-28 ([PR 31](https://github.com/dogma-io/nodely/pull/31))

### Changed
*   Use `babel-preset-nodely` for config and Babel dependencies.

## [0.4.0] - 2018-05-27 ([PR 29](https://github.com/dogma-io/nodely/pull/29))

### Changed
*   Babel to latest Babel 7 beta packages.

## [0.3.0] - 2018-05-27 ([PR 28](https://github.com/dogma-io/nodely/pull/28))

### Changed
*   Stop using default exports as they provide no real benefit and can cause issues with tree-shaking.

## [0.2.1] - 2018-05-27 ([PR 27](https://github.com/dogma-io/nodely/pull/27))

### Changed
*   Flow type so auto-generated Flow types won't break downstream projects using Flow.

## [0.2.0] - 2018-05-25 ([PR 26](https://github.com/dogma-io/nodely/pull/26))

### Changed
*   Generate updated flow types.
*   Dependencies to latest versions.

## [0.1.6] - 2018-05-16 ([PR 25](https://github.com/dogma-io/nodely/pull/25))

### Changed
*   Dependencies to latest versions.

## [0.1.5] - 2018-05-10 ([PR 24](https://github.com/dogma-io/nodely/pull/24))

### Changed
*   `flow-bin` to latest version.

## [0.1.4] - 2018-04-30 ([PR 22](https://github.com/dogma-io/nodely/pull/22))

### Changed
*   Dependencies to latest versions.

## [0.1.3] - 2018-04-20 ([PR 20](https://github.com/dogma-io/nodely/pull/20))

### Changed
*   `flow-bin` to version `0.70.0`.

## [0.1.2] - 2018-04-04 ([PR 19](https://github.com/dogma-io/nodely/pull/19))

### Changed
*   Babel to latest Babel 7 beta.

## [0.1.1] - 2018-03-29 ([PR 17](https://github.com/dogma-io/nodely/pull/17))

### Changed
*   `flow-bin` to latest version.

## [0.1.0] - 2018-03-19 ([PR 16](https://github.com/dogma-io/nodely/pull/16))
